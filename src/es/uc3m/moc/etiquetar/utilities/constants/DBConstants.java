...
public abstract class DBConstants {
    ...
    public static final String[] COMMENTS_COLUMNS = new String[]{ COMMENTS_TABLE_COMMENT_ID, COMMENTS_TABLE_RESOURCE_ID, COMMENTS_TABLE_COMMENT,
            COMMENTS_TABLE_RESOURCE_NAME, COMMENTS_TABLE_DATE};
}