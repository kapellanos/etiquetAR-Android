...
//            tvImageLikes.setText(String.valueOf(viewCounter));
                loader.display(getIntent().getStringExtra(Constants.RESOURCE_URL), ivImageResource, 0, pdDialogImage);
            } else {
                setContentView(R.layout.resource_image_layout);
                getReferences();
                loader.display(getIntent().getStringExtra(Constants.RESOURCE_URL), ivLandscapeImageResource, 0, pdDialogImage);
            }
        } else
...
//            tvImageLikes.setText(String.valueOf(viewCounter));
    ...
    protected void getReferences() {
        ...
        if(isPortrait()) {
            // Orientación Portrait (la original)
            ...
            ivAddComment.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    commentsActivity.putExtra(Constants.RESOURCE_NAME, name);
                    startActivity(commentsActivity);
                }
            });
            ivImageResource.setAdjustViewBounds(true);
        } else {
            // En caso de tener el móvil en modo LandScape, se obtiene el identificador del ImageView que mostrará la imagen a pantalla completa
