...
public class HomeActivity extends YouTubeBaseActivity implements
    ...
    /**
     * Se encarga de comprobar que posición dentro de los tags visitados ocupa el actual y crear un layout adecuado (con flechas indicando que
     * hay más contenido) en caso de ser necesario.
     *
     * @param view La vista en la que situará el contenido principal
     * @param viewLayoutParams Los parámetros de la vista principal.
     * @param container La vista contenedor que contendrá el contenido del recurso actual (sea del tipo que sea)
     * @param forData Vista contenedor que contendrá la información sobre el recurso
     * @param textLinearLayout Layout que contendrá los datos del recurso
     * @param textLinearLayoutParams Los parámetros del layout que contendrá los datos del recurso
     */
